...
namespace Example01
{
    public partial class Form28 : Form
    {
        ...
        private void Form28_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                pbBasket.Image = new Bitmap(@"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\basket.png");
            }
            catch (Exception ex)
            {
            ...
            pbEgg.Image = Image.FromFile(@"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\egg_gold.jpg");
            ...
            pbChicken.Image = Image.FromFile(@"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\chicken.jpg");
        ...
        void tmEgg_Tick(object sender, EventArgs e)
        {
            ...
            {
                pbEgg.Image = Image.FromFile(@"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\egg_gold_broken.jpg");
            ...
            if (!unionRect.IsEmpty) // Nếu có va chạm với giỏ
            {
                ...
                pbEgg.Image = Image.FromFile(@"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\egg_gold.jpg"); // Reset hình trứng về bình thường
