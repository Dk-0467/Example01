...
namespace Example01
{
    public partial class Form26 : Form
    {
        ...
        private void Form26_Load(object sender, EventArgs e)
        {
            ...
            string imagePath = @"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\egg_gold.jpg";  // Thay thế bằng đường dẫn tuyệt đối tới hình ảnh
        ...
        void tmEgg_Tick(object sender, EventArgs e)
        {
            ...
            {
                string imagePath = @"D:\Wed_IT\C#\BuiDucKiem_2122110241\Example01\Example01\Images\egg_gold_broken.jpg";  // Thay thế bằng đường dẫn tuyệt đối tới hình ảnh
                if (System.IO.File.Exists(imagePath))
                {
                    pbEgg.Image = Image.FromFile(imagePath);
                }
